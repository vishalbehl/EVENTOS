...
export function registerTypographyBlocks(editor: Editor) {
  ...
  bm.add('typo-paragraph', {
    ...
    category: 'Typography',
    content: `<p data-gjs-type="paragraph" style="font-size: 16px; line-height: 1.75; color: var(--muted-foreground); margin: 0 0 16px 0; max-width: 680px;">Your paragraph text goes here. Describe your event, section, or content with clear, engaging copy that speaks directly to your attendees.</p>`,
  });

  bm.add('typo-lead', {
    label: card(icon('<line x1="3" y1="5" x2="21" y2="5"/><line x1="3" y1="10" x2="21" y2="10"/><line x1="3" y1="15" x2="14" y2="15"/>'), 'Lead Text'),
    category: 'Typography',
    content: `<p data-gjs-type="lead-text" style="font-size: 20px; line-height: 1.65; color: var(--foreground); font-weight: 400; margin: 0 0 20px 0; max-width: 780px;">This is a lead paragraph. Use it to introduce a section with a slightly larger, more prominent text style than body copy.</p>`,
  });

  bm.add('typo-eyebrow', {
    label: card(icon('<line x1="4" y1="12" x2="20" y2="12"/>'), 'Eyebrow Label'),
    category: 'Typography',
    content: `<p data-gjs-type="subheading" style="font-size: 12px; font-weight: 800; text-transform: uppercase; letter-spacing: 0.15em; color: var(--pri, var(--primary)); margin: 0 0 12px 0;">Category Label</p>`,
  });
  ...
  bm.add('typo-blockquote', {
    ...
    category: 'Typography',
    content: `
      <blockquote data-gjs-type="blockquote" style="border-left: 4px solid var(--pri, var(--primary)); padding: 16px 24px; margin: 0 0 24px 0; background: var(--muted); border-radius: 0 12px 12px 0;">
  ...
  bm.add('typo-counter', {
    ...
    category: 'Typography',
    content: `
      <div data-gjs-type="counter" style="text-align: center; padding: 24px;">
...
const eventData = {
  ...
  bm.add('typo-marquee', {
    ...
    category: 'Typography',
    content: `
      <div data-gjs-type="marquee" style="overflow: hidden; white-space: nowrap; padding: 12px 0; background: var(--muted); border-top: 1px solid var(--border-subtle, var(--muted)); border-bottom: 1px solid var(--border-subtle, var(--muted));">
