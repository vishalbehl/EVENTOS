...
from app.services.analytics_service import get_event_email_analytics
...
async def test_template(
    ...
    from app.services.email_service import build_speaker_variables, build_participant_variables, render_template, send_email
