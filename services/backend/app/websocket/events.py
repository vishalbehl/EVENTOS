...
async def broadcast_file_event(
    ...
    try:
        from app.modules.venue.services.websocket_service import broadcast_to_event  # lazy import
...
async def broadcast_srr_event(
    ...
    try:
        from app.modules.venue.services.websocket_service import broadcast_to_srr  # lazy import
