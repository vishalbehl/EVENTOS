...
class SpeakerUploadToken(Base):
    ...
    id: Mapped[uuid.UUID] = mapped_column(UUID(as_uuid=True), primary_key=True, default=uuid.uuid4)
    speaker_id: Mapped[uuid.UUID] = mapped_column(UUID(as_uuid=True), ForeignKey("speakers.speakers.id", ondelete="CASCADE"), index=True)
...
class SpeakerHonorarium(Base):
    ...
    id: Mapped[uuid.UUID] = mapped_column(UUID(as_uuid=True), primary_key=True, default=uuid.uuid4)
    speaker_id: Mapped[uuid.UUID] = mapped_column(UUID(as_uuid=True), ForeignKey("speakers.speakers.id", ondelete="CASCADE"), unique=True, index=True)
