...
FEATURE_DEFINITIONS: dict[str, dict[str, Any]] = {
    ...
    "FEAT_ABSTRACT_SUBMISSION": _feature("EVENT", ["/events/:eventId/abstracts", "/events/:eventId/abstracts/submissions", "/events/:eventId/abstracts/reviewers", "/events/:eventId/speakers/dashboard"], value_type="TIER", values=["BASIC", "ADVANCED"], operations=["abstracts.submit", "abstracts.configure", "abstracts.review", "abstracts.assign_reviewers", "abstracts.decide", "abstracts.publish", "abstracts.export"], page_gate=False),
...
OPERATION_ENFORCEMENT_SITES: dict[str, list[dict[str, str]]] = {
    ...
    "abstracts.submit": [{"site": "modules/abstracts/router.py:abstract_submission_mutations", "mode": "ENFORCE"}],
    "abstracts.review": [{"site": "modules/abstracts/router.py:abstract_review_mutations", "mode": "ENFORCE"}],
    "abstracts.configure": [{"site": "modules/abstracts/router.py:abstract_call_and_form_mutations", "mode": "ENFORCE"}],
    "abstracts.assign_reviewers": [{"site": "modules/abstracts/router.py:abstract_assignment_mutations", "mode": "ENFORCE"}],
    "abstracts.decide": [{"site": "modules/abstracts/router.py:abstract_decision_mutations", "mode": "ENFORCE"}],
    "abstracts.publish": [{"site": "modules/abstracts/router.py:abstract_publication_mutations", "mode": "ENFORCE"}],
    "abstracts.export": [{"site": "modules/abstracts/router.py:abstract_exports", "mode": "ENFORCE"}],
...
OPERATION_PERMISSIONS: dict[str, str | None] = {
    ...
    "abstracts.configure": "SPEAKERS:EDIT",
    "abstracts.assign_reviewers": "SPEAKERS:EDIT",
    "abstracts.decide": "SPEAKERS:EDIT",
    "abstracts.publish": "SPEAKERS:EDIT",
    "abstracts.export": "SPEAKERS:VIEW",
...
PORTAL_LIMIT_CONTROL_SITES: dict[str, dict[str, Any]] = {
    "max_events": {"mode": "ACTION_GATE", "sites": ["app/(dashboard)/events/new/page.tsx"]},
    "max_users": {"mode": "ACTION_GATE", "sites": ["components/organizer/workspace/people/PeopleMembersTab.tsx"]},
    "max_event_team_members": {"mode": "ACTION_GATE", "sites": ["components/organizer/workspace/access/AccessEventTab.tsx"]},
    ...
    "max_ticket_categories": {"mode": "ACTION_GATE", "sites": ["app/(dashboard)/events/[eventId]/registration/roles/page.tsx"]},
...
MUTATION_CONTROL_EXEMPTIONS: dict[str, dict[str, str]] = {
    "modules/rbac/routers/rbac.py:clone_role": {
        "mode": "CORE_GOVERNANCE",
        "reason": "Role cloning is organization governance and does not grant a commercial entitlement.",
    },
    "modules/rbac/routers/rbac.py:create_role_assignment": {
        "mode": "CORE_GOVERNANCE",
        "reason": "Role assignment is authorization governance and is independently permission-checked.",
    },
    "modules/rbac/routers/rbac.py:update_role": {"mode": "CORE_GOVERNANCE", "reason": "Role governance is independently permission-checked."},
    "modules/rbac/routers/rbac.py:delete_role_assignment": {"mode": "CORE_GOVERNANCE", "reason": "Role assignment governance is independently permission-checked."},
    "modules/speakers/routers/portal.py:portal_save_talk_external_link": {"mode": "CORE_GOVERNANCE", "reason": "Speaker portal content mutation is independently authenticated and scoped."},
    "modules/venue/routers/sync.py:push_registration_source_operations": {"mode": "SIGNED_TRANSPORT", "reason": "Venue synchronization uses the signed source transport boundary."},
