"""
Auto-port finding development server runner for Registration Server.
...
def main():
    parser = argparse.ArgumentParser(description="Registration Server Auto-Port Dev Runner")
    parser.add_argument("--port", type=int, default=8002, help="Preferred starting port (default: 8002)")
    ...
    if selected_port != args.port:
        ...
        print(f"[START] Registration Server starting on http://{args.host}:{selected_port}")
        print(f"==================================================\n")
    else:
        print(f"\n==================================================")
        print(f"[START] Registration Server starting on http://{args.host}:{selected_port}")
