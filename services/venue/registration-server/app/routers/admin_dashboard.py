...
async def get_dashboard_metrics(
    ...
    # Registration Server intentionally does not depend on presentation-backed
    # venue sync job models. The local outbox below is the authoritative
    # registration push/freshness state for this app.
    sync_jobs = []
