...
class PlaybackEvent(Base):
    ...
    # ── Relationships ─────────────────────────────────────
    queue_entry: Mapped["PresentationQueue"] = relationship(
        "PresentationQueue", back_populates="playback_events"
    )
    device: Mapped["RoomDevice"] = relationship(
        "RoomDevice", back_populates="playback_events"
    )
