...
async def reload_database(
    ...
    try:
        ...
        return {
            "status": "success",
            "message": "Database engine hot-reloaded successfully.",
            "target_url": target_url.split("@")[-1] if "@" in target_url else target_url,
        }
    except Exception as e:
        raise HTTPException(status_code=500, detail=f"Failed to reload database: {e}")
