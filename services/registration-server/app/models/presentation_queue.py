...
class PresentationQueue(Base):
    ...
    session_speaker: Mapped["SessionSpeaker"] = relationship("SessionSpeaker")
    file: Mapped["PresentationFile"] = relationship("PresentationFile")
    device: Mapped[Optional["RoomDevice"]] = relationship("RoomDevice")
