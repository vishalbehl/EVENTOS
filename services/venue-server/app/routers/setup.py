...
class BootstrapRequest(BaseModel):
    ...
    admin_username: str = Field(min_length=3, max_length=80, pattern=r"^[A-Za-z0-9_.-]+$")
...
async def setup_status(db: AsyncSession = Depends(get_database)) -> dict:
    ...
    return {
        "setup_required": user_count == 0 or install is None or install.setup_status != "complete",
