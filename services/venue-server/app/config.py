...
class VenueSettings(BaseSettings):
    ...
    PORT: int = 8001
    HOST: str = "0.0.0.0"
    CORS_ORIGINS: str = "http://127.0.0.1:3006,http://localhost:3006,http://127.0.0.1:3007,http://localhost:3007"
    PUBLIC_BASE_URL: str = "http://127.0.0.1:8001"
    VENUE_CA_CERT_PATH: str = ""

    # Security (Local Auth Key for Kiosks/Displays)
    VENUE_AUTH_KEY: str = ""  # Provisioned by the installer; never use a shared default.
    VENUE_AUTH_SECRET: str = ""
    VENUE_ACCESS_TOKEN_MINUTES: int = 480
    VENUE_BOOTSTRAP_ADMIN_USERNAME: str = ""
    VENUE_BOOTSTRAP_ADMIN_EMAIL: str = ""
    VENUE_BOOTSTRAP_ADMIN_PASSWORD: str = ""
