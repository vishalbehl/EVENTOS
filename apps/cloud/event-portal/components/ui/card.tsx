...
>(({ className, variant = "default", ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "card rounded-[var(--radius-panel)] text-[var(--text)]",
      variant === "inset" && "bg-[var(--bg-surface-3)]",
      variant === "interactive" && "cursor-pointer rounded-[var(--radius-card)] transition-[transform,box-shadow,border-color] duration-200 hover:-translate-y-0.5 hover:border-[var(--text-tertiary)] hover:shadow-md",
