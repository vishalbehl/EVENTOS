  ...
  },
  {
    ...
    items: [
      { label: "Organizations", icon: Building2, href: "/super-admin/organizations" },
      {
        ...
        icon: CreditCard,
        children: [
          { label: "Plans", icon: Sliders, href: "/super-admin/commercial/plans" },
          ...
          { label: "Revenue", icon: TrendingUp, href: "/super-admin/commercial/revenue" },
          { label: "Add-ons", icon: Puzzle, href: "/super-admin/commercial/plans" },
          { label: "Credits & Wallet", icon: Wallet, href: "/super-admin/commercial/revenue" },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        icon: ShieldCheck,
        children: [
          { label: "Users", icon: Users2, href: "/super-admin/security/users" },
      ...
      },
      {
        ...
        icon: Cpu,
        children: [
          { label: "Infrastructure", icon: Server, href: "/super-admin/operations/health" },
          { label: "Background Jobs", icon: Activity, href: "/super-admin/operations/jobs" },
          { label: "Queues", icon: Layers, href: "/super-admin/operations/jobs" },
          { label: "Database", icon: Database, href: "/super-admin/operations/database" },
          { label: "Storage", icon: HardDrive, href: "/super-admin/operations/storage" },
          { label: "Email Delivery", icon: Mail, href: "/super-admin/operations/health" },
        ],
      },
      {
        label: "Support",
        icon: HeadphonesIcon,
        children: [
          { label: "Tickets", icon: Ticket, href: "/super-admin/support/tickets" },
          { label: "Customers", icon: Users2, href: "/super-admin/support/tickets" },
          { label: "Knowledge Base", icon: HelpCircle, href: "/super-admin/support/tickets" },
          { label: "SLA", icon: AlertOctagon, href: "/super-admin/support/sla" },
        ],
      },
      {
        label: "Settings",
        ...
        children: [
          ...
          { label: "Security Policies", icon: Lock, href: "/super-admin/settings/security" },
          { label: "Notifications", icon: Bell, href: "/super-admin/settings/general" },
          { label: "Feature Catalog", icon: Sliders, href: "/super-admin/settings/feature-catalog" },
          { label: "Plans Config", icon: Sliders, href: "/super-admin/settings/general" },
          { label: "Email Templates", icon: Mail, href: "/super-admin/settings/email-templates" },
          { label: "API Management", icon: Key, href: "/super-admin/settings/general" },
          { label: "System Config", icon: Settings, href: "/super-admin/settings/general" },
          { label: "Maintenance", icon: AlertOctagon, href: "/super-admin/settings/general" },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        icon: Code2,
        children: [
          { label: "API Analytics", icon: BarChart2, href: "/super-admin/developer/analytics" },
          { label: "Webhooks", icon: Webhook, href: "/super-admin/developer/webhooks" },
          { label: "Rate Limits", icon: Lock, href: "/super-admin/developer/rate-limits" },
          { label: "Integrations", icon: Puzzle, href: "/super-admin/developer/integrations" },
        ],
      },
    ],
  },
