...
import { Command, ArrowRight, HelpCircle } from "lucide-react";
      ...
      >
        ...
        <header className="mb-10 text-center relative z-10">
          ...
          <h1 className="text-3xl font-black tracking-tighter text-glow-indigo mb-2">
            Speaker <span className="text-indigo-400">Hub</span>
          </h1>
          <p className="text-muted text-[10px] font-black uppercase tracking-[0.2em]">Ecosystem Intake Portal</p>
        </header>
        ...
        <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
          ...
          >
            {isSubmitting ? "Routing..." : (
              <>
                Open Speaker Portal <ArrowRight className="h-4 w-4" />
              </>
            )}
          </button>
        </form>
        ...
        <footer className="mt-12 pt-8 border-t border-white/5 text-center flex items-center justify-center gap-2 text-muted">
          ...
          <p className="text-[10px] font-bold">
            Please use the Event ID shared by your organizer.
          </p>
        </footer>
      </motion.div>
