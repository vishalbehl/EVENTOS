...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-12 items-center justify-center rounded-2xl bg-[var(--surf)] border border-[var(--border)] p-1 text-muted-foreground",
      className
    )}
    {...props}
  />
