            ...
            >
              <div className="p-8">
                <div className="flex items-center justify-between mb-8">
                  ...
                  <button onClick={onClose} className="h-10 w-10 rounded-full border border-[var(--border)] bg-[var(--surf)] flex items-center justify-center text-muted hover:text-[var(--text)] transition-all">
                    <X className="h-4 w-4" />
                  </button>
                </div>
